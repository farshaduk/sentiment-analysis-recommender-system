...
> **Core Question:** Can we accurately predict sentiment in technical product reviews and use that sentiment signal to improve product recommendations?
...
|---|---|---|
| 🧠 Sentiment Analysis | VADER + TextBlob lexicon models | VADER performed better overall |
| 🤖 Machine Learning | TF-IDF + Logistic Regression + Linear SVM | Linear SVM achieved the best classification result |
| 🛒 Recommender System | Sentiment-enhanced collaborative filtering | RMSE improved by **24.9%** |
| 📝 LLM Tasks | Review summarisation + CSR response generation | BART + FLAN-T5 used for automation |
| 📊 Dataset | Amazon Industrial & Scientific reviews | **77,071** reviews analyzed |
